...
public class SwitcherAspects {
     ...
     */
    @Around("execution (* dm.tools.switchers.AbstractSwitcher.toggle())")
     ...
     * @throws Throwable any exception thrown by the intercepted method
     */
    @Around("execution (* dm.tools.switchers.AbstractSwitcher.switchOn())")
    @SuppressWarnings("unchecked")
     ...
     * @throws Throwable any exception thrown by the intercepted method
     */
    @Around("execution (* dm.tools.switchers.AbstractSwitcher.switchOff())")
    @SuppressWarnings("unchecked")
