...
public class RequiredTextFieldAspects {
    ...
    @Around("execution (* dm.tools.inputs.AbstractRequiredTextField.assertMarkedAsRequired(..))")
    ...
    @Around("execution (* dm.tools.inputs.AbstractRequiredTextField.assertNotMarkedAsRequired(..))")
    @SuppressWarnings("unchecked")
