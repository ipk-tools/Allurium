...
public class TextFieldAspects {
     ...
     */
    @Around("execution (* dm.tools.inputs.TextField.write(String))")
     ...
     * @throws Throwable if the original method throws an exception
     */
    @Around("execution (* dm.tools.inputs.TextField.clear(..))")
    @SuppressWarnings("unchecked")
     ...
     * @throws Throwable if the original method throws an exception
     */
    @Around("execution (* dm.tools.inputs.TextField.pressEnter(..))")
    @SuppressWarnings("unchecked")
     ...
     * @throws Throwable if the original method throws an exception
     */
    @Around("execution (* dm.tools.inputs.TextField.assertEmpty(..))")
    @SuppressWarnings("unchecked")
     ...
     * @throws Throwable if the original method throws an exception
     */
    @Around("execution (* dm.tools.inputs.TextField.assertNotEmpty(..))")
     ...
     * @throws Throwable if the original method throws an exception
     */
    @Around("execution (* dm.tools.inputs.TextField.assertCurrentValue(String))")
     ...
     * @throws Throwable if the original method throws an exception
     */
    @Around("execution (* dm.tools.inputs.TextField.assertCurrentValueContains(String))")
