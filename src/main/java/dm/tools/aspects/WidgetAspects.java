...
import dm.tools.exceptions.WidgetFormalizationException;
import dm.tools.interfaces.WebElementMeta;
...
public class WidgetAspects {
    ...
    @After("within(@dm.tools.annotations.Widget *) && execution(*.new(..))")
    ...
    @Before("get(@dm.tools.annotations.LocatorChain * *)")
    ...
    @Before("get(@dm.tools.annotations.ListLocatorChain * *)")
    ...
    /*
    @After("execution (* dm.tools.lists.ListWC.refresh())")
