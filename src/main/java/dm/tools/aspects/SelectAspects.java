...
public class SelectAspects {
     ...
     */
    @Around("execution (* dm.tools.inputs.Select.select(String))")
     ...
     * @throws Throwable if the intercepted method throws any exception
     */
    @Around("execution (* dm.tools.inputs.Select.select(int))")
    @SuppressWarnings("unchecked")
    ...
    /*
    @Around("execution (* dm.tools.inputs.Select.selectByArrowsLeftAndRight(String))")
    @SuppressWarnings("unchecked")
     ...
     * @throws Throwable if the intercepted method throws any exception
     */
    @Around("execution (* dm.tools.inputs.Select.selectFirst())")
    @SuppressWarnings("unchecked")
     ...
     * @throws Throwable if the intercepted method throws any exception
     */
    @Around("execution (* dm.tools.inputs.Select.selectLast())")
    @SuppressWarnings("unchecked")
     ...
     * @throws Throwable if the intercepted method throws any exception
     */
    @Around("execution (* dm.tools.inputs.Select.selectAny())")
    @SuppressWarnings("unchecked")
     ...
     * @throws Throwable if the intercepted method throws any exception
     */
    @Around("execution (* dm.tools.inputs.Select.selectAnyBesides(String))")
    @SuppressWarnings("unchecked")
     ...
     * @throws Throwable if the intercepted method throws any exception
     */
    @Around("execution (* dm.tools.inputs.Select.assertCurrentValue(String))")
     ...
     * @throws Throwable if the intercepted method throws any exception
     */
    @Around("execution (* dm.tools.inputs.Select.assertCurrentValueIsNot(String))")
     ...
     * @throws Throwable
     */
    @Around("execution (* dm.tools.inputs.Select.assertHasItems(List))")
